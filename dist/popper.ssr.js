...
function usePopper(_ref) {
  ...
  vue.watch([function () {
    return state.isOpen;
  }, placement, strategy], /*#__PURE__*/function () {
...
styleInject(css_248z);script.__scopeId = "data-v-334e58bb";// IIFE injects install function into component, allowing component
